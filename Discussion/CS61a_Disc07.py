...
class Keyboard:
    ...
    def __init__(self):
        self.typed = []
        self.keys = {k: Button(k,lambda x:self.typed.append(x)) for k in LOWERCASE_LETTERS}  # Try a dictionary comprehension!
